...
let
  env = {
    URL.value = "https://docs.berkeley.mt";
    PORT.value = "3000";
    ...
    GOOGLE_CLIENT_ID.value = "799809453242-iesp4onlaje1hu5h97iq313h6f06mjuo.apps.googleusercontent.com";

    SMTP_HOST.value = "smtp.resend.com";
    SMTP_PORT.value = "465";
    SMTP_USERNAME.value = "resend";
    SMTP_PASSWORD.valueFrom.secretKeyRef = { name = "outline"; key = "RESEND_API_KEY"; };
    SMTP_FROM_EMAIL.value = "noreply@berkeley.mt";
  };
